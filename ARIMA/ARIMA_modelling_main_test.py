...
#Step 1 
data_df = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/ABBANK_ACI_test.csv')
...
train.to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/train.csv')
dev.to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/dev.csv')
test1.to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/test1.csv')
test2.to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/test2.csv')

#Step 4
#Plotting the ACF and PACf for finding the appropriate ARIMA model
train = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/train.csv')
train = np.transpose(train.loc[:, ~train.columns.str.contains('^Unnamed')])

'''for _ in range(2000, 2005, 1):
...
train = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/train.csv')
dev = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/dev.csv')
test1 = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/test1.csv')
test2 = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/before_arima/test2.csv')
...
model_021 = ARIMA(order=(0,2,0), method='mle', suppress_warnings=True) #120
...
pd.DataFrame(train_X).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/train_X.csv')
pd.DataFrame(dev_X).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/dev_X.csv')
pd.DataFrame(test1_X).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/test1_X.csv')
pd.DataFrame(test2_X).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/test2_X.csv')
pd.DataFrame(train_Y).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/train_Y.csv')
pd.DataFrame(dev_Y).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/dev_Y.csv')
pd.DataFrame(test1_Y).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/test1_Y.csv')
pd.DataFrame(test2_Y).to_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/test2_Y.csv')
    

train = pd.read_csv('C:/Users/RAFAT/Desktop/Corr_Prediction_ARIMA_LSTM_Hybrid_main/train_dev_test_main_test/after_arima/train_X.csv')
train = np.transpose(train.loc[:,~train.columns.str.contains('^Unnamed')])
...
out_of_bound = X + Y
print(str(len(out_of_bound)/1) +' % of the data is out of bound [-2,2]')

X = [x for x in train_melt if x>1]
Y = [y for y in train_melt if y<-1]
out_of_bound = X + Y
print(str(len(out_of_bound)/1) +' % of the data is out of bound [-1,1]')
